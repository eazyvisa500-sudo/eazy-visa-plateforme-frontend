...
import { LayoutDashboard, Users, FileText, BarChart3, CalendarCheck, Wallet, Plane, LogOut, User } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/admin/reservations', label: 'Réservations', icon: <CalendarCheck className="w-4 h-4" /> },
  ...
  { path: '/admin/politiques', label: 'Politiques', icon: <Plane className="w-4 h-4" /> },
];
